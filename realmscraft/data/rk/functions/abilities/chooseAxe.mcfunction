...
give @s[tag=Skirmisher] minecraft:stone_axe{Unbreakable:1}
give @s[tag=Skirmisher] minecraft:bow{Unbreakable:1}
tell @s[tag=Skirmisher] Excellent, now pick your spells in the Ability Selection Book!

give @s[tag=Caster] minecraft:golden_axe{Unbreakable:1}
